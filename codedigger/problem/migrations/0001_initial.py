    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.CharField(blank=True, max_length=20, null=True)),
                ('rating', models.CharField(blank=True, max_length=10, null=True)),
                ('platform', models.CharField(choices=[('F', 'Codeforces'), ('C', 'Codechef'), ('S', 'Spoj'), ('U', 'Uva'), ('A', 'Atcoder')], max_length=1)),
                ('difficulty', models.CharField(blank=True, choices=[('B', 'Beginner'), ('E', 'Easy'), ('M', 'Medium'), ('H', 'Hard'), ('S', 'Super-Hard'), ('C', 'Challenging')], max_length=1, null=True)),
