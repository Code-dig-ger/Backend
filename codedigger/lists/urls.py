...
urlpatterns = [
    ...
    path('userlist/add', UserlistAddProblemView.as_view(),
         name='userlist-add'),
    ...
    path('view-enrolled-lists/', ViewAllEnrollListView.as_view(), name='view-enrolled-lists'),
