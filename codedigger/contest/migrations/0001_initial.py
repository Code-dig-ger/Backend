    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='codeforces_contest_user', to='codeforces.user')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codeforcesContest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contest.codeforcescontest')),
        ...
        migrations.AddField(
            ...
            name='problem',
            field=models.ManyToManyField(related_name='codeforces_contest_problem', through='contest.CodeforcesContestProblem', to='problem.Problem'),
        ),
    ]
