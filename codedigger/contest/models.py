...
class CodeforcesContest(models.Model):
    ...
    problem = models.ManyToManyField(Problem,
                                     ...
                                     through_fields=('codeforcesContest',
                                                     'problem'),
...
class CodeforcesContestProblem(models.Model):
    codeforcesContest = models.ForeignKey(CodeforcesContest,
                                          on_delete=models.CASCADE)
...
#                                      through_fields=('contest', 'problem'),
#                                      related_name='contest_problem')
#     participants = models.ManyToManyField(User,
#                                           through='ContestParticipation',
...
#                                        on_delete=models.CASCADE)
#     contestParticipation = models.ForeignKey(ContestParticipation,
#                                              on_delete=models.CASCADE)
#     submissionTime = models.DurationField()
#     penalty = models.IntegerField()

#     def __str__(self):
#         return self.contestParticipation.user.username + " " + str(
#             self.penalty
...
#     def __str__(self):
#         if self.isSolved:
#             return self.participant.user.handle + " solved " + self.participant.contest.name + " - " + str(
#                 self.problemIndex)
#         else:
