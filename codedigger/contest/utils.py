...
def login():
    ...
    ftaa = ''.join(random.choices('abcdefghijklmnopqrstuvwxyz0123456789',
                                  k=18))
    ...
    Cookie = res.headers['Set-Cookie'][:47] + res.headers['Set-Cookie'][
        66:81] + res.headers['Set-Cookie'][146:199]
    return Cookie
...
def penalty(cookie, contestId, subId, groupId):
    ...
    url = "https://codeforces.com/group/" + str(groupId) + "/contest/" + str(
        contestId) + "/submission/" + str(subId)
