...
class TestModelUtils(TestSetUp):
    ...
    def test_CreateContest(self):
        ...
        contestDate = datetime.strptime(codechef_contest["StartTime"],
                                        "%d %B %Y  %H:%M:%S")
        contest = CodechefContest.objects.get(
            contestId=codechef_contest["ContestCode"])
    ...
    def test_CreateProblem(self):
        ...
        codechefProblem = CodechefContestProblems.objects.filter(
