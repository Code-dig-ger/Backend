...
from codeforces.test_fixtures.models_utils_fixture import (cf_user, cf_contest, 
                                                            cf_problem, rating_change_data)
from codeforces.models_utils import (create_or_update_user, create_or_update_contest,
                                    create_or_update_problem, update_and_save_contest_data)
